export const zh = {
  ...
  pageDesc:
    "運用信令及票證數據，研究內湖科技園學整體的通勤狀態，並從分析洞見提出政策建議。",
  ...
  article: {
    ...
    step4: {
      ...
      p1: "本次研究，透過",
      annotationContent1:
        "電信業者透過手機訊號，推估空間範圍內的人口變化。這能幫助我們更精確掌握如上下班通勤的實際流動、居住與就業地分佈等資訊。",
      p2: "推估大內科的人口特性。大內科工作人口為13萬3500人，從右圖可知整體大內科屬於工作為主的區域較少住商混合的狀態，多數人前往大內科工作，需要較長距離的通勤。",
      p3: "此外，對比",
      annotationTrigger2: "台北市建成區",
      annotationContent2:
        "指市行政區範圍內經過徵用的土地和實際建設發展起來的非農業生產建設地段，它包括市區集中連片的部分以及分散在近郊區與城市有著密切聯繫，具有基本完善的市政公用設施的城市建設用地（如機場、鐵路編組站、污水處理廠、通訊電台等）。",
    ...
    step6: {
      ...
      annotationContent1:
        "步驟一、篩選出位於大內科範圍內的捷運、公車及YouBike 站點。<br>步驟二、統計各站點在上班時段的上車（騎乘）起點。<br>步驟三、繪製各站點的服務半徑，依照最小統計單元的人口密度，將人數分配至 250m*250m 的網格。以便依照顏色深淺區分使用量。",
    },
    step7: {
      ...
      annotationContent1:
        "私人運具通勤工作人口：來源地總工作人口減去來源地大眾運輸通勤工作人口，此方法僅為推估總體的通勤現況，若該區域的大眾運輸通勤工作人口超過來源地總工作人口，表示有使用其他通勤方式至該區域搭乘大眾運輸的行為。",
    },
    step9: {
  ...
  footer: {
    ...
    participate: "專案參與",
    menber:
      "專案顧問 Roy Lin<br>資料分析 Ian Tsern<br>前端工程 Ingrid Kao<br>文章編輯 Lowlow Wang",
    collaborate: "合作單位",
    unit: "交通局",
...
export const en = {
  ...
  subTitle: "",
  pageDesc:
    "Using cellphone-based data and ticket data to analyize the Decoding the Commute Pattern of Neihu Tech Park and derive insights to facilitate policy-making.",
  ...
  article: {
    ...
    step2: {
      title:
        "Neihu Traffic Improvement Project: Learning More about the Greater Neihu Park",
      p1: "According to ",
      ...
      annotationTrigger2:
        "the analysis commissioned by the Department of Transportation",
    ...
    step4: {
      title:
        "Over 130,000 Workers, Mostly Commuting from Outside the Tech Park",
      p1: "This study utilizes ",
      annotationContent1:
        "Telecom operators estimate demographic changes via cell phone-based signals. This allows us to understand the pattern of commuters, including their flow, residential and working areas.",
      ...
      annotationContent2:
        "Built area refers to zoned urban lands that are non-agricultural use, often equipped with urban infrastructure including transportation, drainage, power grids, etc.",
    ...
    step5: {
      title:
        "Where Do the Workers Come from? Mostly from Shilin, Songshan, and Xizhi",
    ...
    step6: {
      title:
        "There Are About 30% of Neihu Tech Park Commuters Use Public Transit",
      p1: "MRT and buses are the most important public transit systems in Taipei. We used",
      annotationTrigger1:
        "Easy Card transaction data and geo-spatial analytics",
      ...
      annotationContent1:
        "Step 1: Isolate MRT, bus, YouBike stations within Neihu Tech Park region.<br>Step 2: Summarize the origins of the trips arriving to the stations.<br>Step 3: Define service area for the origin stations, and redistribute the passenger numbers to the 250 by 250 meter spatial grid proportionally to local census population density.",
    },
    step7: {
      title:
        "Commuters from Which Areas Utilize the Least Amount of Public Transportation?",
      ...
      annotationContent1:
        "Calculation for private vehicle commute workers:  Total working population from the origins minus public transit passengers from the origins. ",
    },
    step9: {
      title:
        "Understanding the Dilemma of Commuters through Analysis of Public Transportation Use",
    ...
    step10: {
      ...
      supTitle:
        "Origin and Destination Hot Spots for Morning and Evening Commute",
    ...
    step13: {
      ...
      annotationContent1:
        "The map service company TOMTOM pointed out that when the total traffic volume of cities returned to 80-90% in the post-pandemic time, traffic congestion can be effectively prevented when the flow rate is reduced by 10-15%; more details can be found in the Tomtom research report. See reference 4 for the link.",
      annotationContent2:
        "London Government appointed ULEZs where drivers are required to pay £12.5 to drive within. More details can be found in the official report. See reference 5 for the link.",
    },
  },
  box: {
    speedLabel: {
    ...
    ratioLabel:
      "When exceeds 100%, its assummed to be including commuters transferring at the location from other region.",
  },
  charts: {
    columnBasic: {
  ...
  footer: {
    ...
    linkHost2:
      "China Engineering Consultants, Inc., Chinese Management Association.",
    linkTitle2: "2019 SmartCity Taiwan Forum",
    linkHost3: "Taipei City Department of Transportation",
    linkTitle3:
      "FY 2019 Taipei City Traffic Corridor Road Traffic Integration and Telecommunication Data Application Service Project",
    linkHost5: "Greater London Authority",

    title2: "Data Used",
    linkTitle4: "Tom Tom Traffic stats 2019/04",
    linkTitle5:
      "Telecom Signal Data: Work Population and Residence Population Estimate 2020/06",
    linkTitle6:
      "Telecom Signal Data: Work Population Place of Residency Population Estimate 2020/06",
    linkTitle7:
      "MRT Daily Hour-Minute-Station OD Passenger Flow Volume Statistics 2020/06",
    linkTitle8:
      "Bus Boarding and Disembarking Card Swipe Transaction Records 2020/06",
    linkTitle9:
      "YouBike Vehicle Hire and Return Card Swipe Transaction Records 2020/06",

    participate: "Team",
    menber:
      "Advisor Roy Lin<br>Data analysis: Ian Tsern<br>Frontend engineer: Ingrid Kao<br>Article editor Lowlow Wang",
    ...
    tel: "Phone",
    telInfo: [
      "Taipei City 1999 Citizens'Hotline",
      "ext. 8585 (Toll-free number, with the exception of public phones, Fangxinjiang phone plan, and Type II Telecoms), Please dial",
